# PT Tracker & Rehab Coverage - Developer Documentation

## System Overview

This is a Progressive Web App (PWA) for tracking physical therapy exercises and monitoring rehab coverage across functional movement capacities.

**Main Components:**
- `pt_tracker.html` - Main exercise tracking interface
- `rehab_coverage.html` - Coverage analysis view showing exercise distribution by region/capacity/focus
- `exercise_library.json` - Complete exercise library with instructions and metadata
- `exercise_roles.json` - Maps exercises to functional roles (region, capacity, focus, contribution)
- `exercise_roles_vocabulary.json` - Human-readable definitions for all terms
- `schema/exercise_roles.schema.json` - JSON Schema defining valid enums and structure
...
For bugs or feature requests, consult this README first. Most issues are covered in the "Common Issues" section.
