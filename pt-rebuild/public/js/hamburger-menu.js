 ...
 * needs the ☰ trigger button. Page-specific items are passed as menuItems config.
 * Nav links are auto-generated by renderNavLinks() based on current page and role.
 *
 * Usage:
 * 1. Add the hamburger trigger button: <button data-action="toggle-hamburger">☰</button>
...
const HamburgerMenu = {
    config: {
        ...
        signOutFn: null,
        onAction: null,
        showTrackerLink: null, // deprecated — no-op after DN-006
     ...
     * Pages only need the ☰ trigger button; all panel HTML is generated here.
     * Idempotent — skips if #hamburgerMenu already exists in the DOM.
     */
    inject() {
        ...
        // Fixed-position elements — DOM order doesn't matter for layout
    ...
    handleAction(e) {
        ...
        // Stop propagation only for handled actions — prevents document-level
