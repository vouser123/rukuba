...
- [`hooks/useTrackerSession.js`](C:/Users/cindi/OneDrive/Documents/GitHub/rukuba/pt-rebuild/hooks/useTrackerSession.js): Owns the active tracker-session lifecycle for the index page, including selected exercise state, draft session state, timer/modal flow, optimistic history insertion, finish-session save behavior, and the live form-parameter context handed from tracker state into manual/next-set logging.
